...
@Component({
  ...
  styles: [`
    ...
    :host-context([data-theme="dark"]) .current-plan { color: #e2e8f5 !important; }
    :host-context([data-theme="dark"]) .feature-list li { color: #e2e8f5 !important; }
    :host-context([data-theme="dark"]) .feature-list li.locked { color: #8393ad !important; }
    :host-context([data-theme="dark"]) .btn--ghost { color: #e2e8f5 !important; border-color: #232d42 !important; }
    :host-context([data-theme="dark"]) .feature-row { border-bottom-color: #232d42 !important; }
    :host-context([data-theme="dark"]) .feature-row__label { color: #e2e8f5 !important; }
    :host-context([data-theme="dark"]) .feature-row__desc { color: #8393ad !important; }
  `]
})
