...
.empty { text-align: center; color: #9ca3af; padding: 2.5rem 1rem; }
    ...
    :host-context([data-theme="dark"]) .modal { background: #161c28 !important; box-shadow: 0 8px 32px rgba(0,0,0,.5) !important; }
    :host-context([data-theme="dark"]) .content-title,
    :host-context([data-theme="dark"]) .detail-name,
    :host-context([data-theme="dark"]) .balance-val,
    :host-context([data-theme="dark"]) .invoices-title,
    :host-context([data-theme="dark"]) .invoice-current__value,
    :host-context([data-theme="dark"]) .modal-head h2 { color: #e2e8f5 !important; }
    :host-context([data-theme="dark"]) .flat-name { color: #e2e8f5 !important; }
    :host-context([data-theme="dark"]) .flat-sub,
    :host-context([data-theme="dark"]) .flat-chevron,
    :host-context([data-theme="dark"]) .empty,
    :host-context([data-theme="dark"]) .input-hint,
    :host-context([data-theme="dark"]) .adjust-hint,
    :host-context([data-theme="dark"]) .preset-label,
    :host-context([data-theme="dark"]) .invoice-current__label,
    :host-context([data-theme="dark"]) .invoice-limit,
    :host-context([data-theme="dark"]) .modal-close { color: #8393ad !important; }
    :host-context([data-theme="dark"]) .flat-balance { color: #60a5fa !important; }
    :host-context([data-theme="dark"]) .flat-item { border-bottom-color: #232d42 !important; }
    :host-context([data-theme="dark"]) .flat-item:hover { background: #1e2638 !important; }
    :host-context([data-theme="dark"]) .flat-icon,
    :host-context([data-theme="dark"]) .detail-icon,
    :host-context([data-theme="dark"]) .preset-wrap { background: #1e2638 !important; border-color: #232d42 !important; }
    ...
    :host-context([data-theme="dark"]) .bullet { color: #4ade80 !important; }
    :host-context([data-theme="dark"]) .sidebar-hr,
    ...
    :host-context([data-theme="dark"]) .balance-row,
    :host-context([data-theme="dark"]) .invoice-current { background: #1e2638 !important; }
    :host-context([data-theme="dark"]) .invoice-current { border-left-color: #4ade80 !important; }
    :host-context([data-theme="dark"]) .action-card { background: #1e2638 !important; border-color: #232d42 !important; color: #c5cdd9 !important; }
    :host-context([data-theme="dark"]) .action-card:hover { border-color: #4ade80 !important; }
    :host-context([data-theme="dark"]) .invoice-row { border-bottom-color: #232d42 !important; color: #c5cdd9 !important; }
    ...
    :host-context([data-theme="dark"]) .preset-btn { background: #1e2638 !important; }
    :host-context([data-theme="dark"]) .preset-btn:hover { background: #232d42 !important; border-color: #232d42 !important; }
