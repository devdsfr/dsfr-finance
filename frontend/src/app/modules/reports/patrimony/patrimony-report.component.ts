...
@Component({
  ...
  styles: [`
    ...
    :host-context([data-theme="dark"]) .chart-area { background: #161c28 !important; }
    :host-context([data-theme="dark"]) .bar-label { color: #8393ad !important; }
    :host-context([data-theme="dark"]) .bar-month { color: #8393ad !important; }
    :host-context([data-theme="dark"]) .table { background: #161c28 !important; }
    :host-context([data-theme="dark"]) .table th, .table td { border-bottom-color: #232d42 !important; }
    :host-context([data-theme="dark"]) .table th { background: #1e2638 !important; }
