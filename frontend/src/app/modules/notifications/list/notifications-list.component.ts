...
@Component({
  ...
  styles: [`
    ...
    /* ══ DARK THEME (auto) ══ */
    :host-context([data-theme="dark"]) .notif-row { background: #161c28 !important; }
    :host-context([data-theme="dark"]) .notif-text { color: #8393ad !important; }
    :host-context([data-theme="dark"]) .notif-time { color: #8393ad !important; }
    :host-context([data-theme="dark"]) .btn--ghost { color: #8393ad !important; }
    :host-context([data-theme="dark"]) .empty { color: #8393ad !important; background: #161c28 !important; }
  `]
})
